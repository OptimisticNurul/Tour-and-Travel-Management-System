    ...
    public class ToursController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<TourDTO>>> GetTours()
        {
            var tours = await _context.Tours
                ...
                .Include(t => t.TourPackage) // Include TourPackage
                .Select(t => new TourDTO
                {
                    ...
                    TotalAmount = t.TourPackage.TotalAmount, // Fetch TotalAmount from TourPackage
                    TourPackageId = t.TourPackageId,
                    TourImages = t.TourImage.Select(i => new TourImageDTO { Picture = i.Picture }).ToList(),
                    TourAvailabilities = t.TourAvailabilities.Select(a => new TourAvailabilityDTO { AvailableSlots = a.AvailableSlots }).ToList()
                })
                .ToListAsync();
        ...
        public async Task<ActionResult<Tour>> GetTour(int id)
        {
            var tour = await _context.Tours
                ...
                .Include(t => t.TourAvailabilities)
                .Include(t => t.TourImage) // Ensure this is correct
        ...
        public async Task<IActionResult> PutTour(int id, [FromForm] TourImageVM tourImageVM)
        {
            ...
            Console.WriteLine("Received TourImageVM: " + Newtonsoft.Json.JsonConvert.SerializeObject(tourImageVM));
